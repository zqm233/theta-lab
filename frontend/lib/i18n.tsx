...
const translations = {
  ...
  navDual: { zh: "双币投资", en: "Dual Investment" },
  navAccounts: { zh: "资产总览", en: "Portfolio" },
  navDevtools: { zh: "Agent 工具", en: "Agent DevTools" },
  darkMode: { zh: "深色", en: "Dark" },
  lightMode: { zh: "浅色", en: "Light" },
  watchlist: { zh: "自选", en: "Watchlist" },
  watchlistPlaceholder: { zh: "输入股票代码", en: "Enter ticker" },

  // OptionsChain
  expiration: { zh: "到期日：", en: "Expiration:" },
  loading: { zh: "加载中...", en: "Loading..." },
  loadFailed: { zh: "加载失败", en: "Failed to load" },
  expiredExpiration: { zh: "到期日已过期，无法加载期权链", en: "Expiration date has passed" },
  ...
  expiredWorthless: { zh: "OTM到期归零", en: "Expired Worthless" },
  exercised: { zh: "被行权", en: "Exercised" },
  closeExpiredWorthless: { zh: "平仓（OTM到期）", en: "Close (Expired OTM)" },
  closeExercised: { zh: "平仓（被行权）", en: "Close (Exercised)" },
  exitManual: { zh: "手动", en: "Manual" },
  exitExercised: { zh: "被行权 ⚠️", en: "Exercised ⚠️" },
  exitExpiredWorthless: { zh: "到期归零", en: "Expired OTM" },
  closeMethod: { zh: "平仓方式", en: "Close Method" },
  ...
  allExpirations: { zh: "全部到期日", en: "All Expirations" },
  portfolioPaperNote: {
    zh: "以下为本地手动维护的模拟/纸面持仓，未连接任何美股券商；AI 仅提供研究与建议，不会代为下单。",
    en: "Positions are manual paper tracking only — not linked to any US broker. The AI provides research and does not place listed options orders.",
  },
  settingsProductScope: {
    zh: "美股期权：行情与链为只读分析；持仓与交易记录为本地纸面跟踪。加密货币相关操作仅在启用 MCP 且经你于对话中明确确认后可能执行。",
    en: "US options: chain data is read-only for analysis; portfolio and trades are local paper tracking. Crypto actions via MCP run only after explicit confirmation in chat when enabled.",
  },
  ...
  // Dual Investment - Tabs
  dualTabProducts: { zh: "可购买产品", en: "Available Products" },
  dualTabOrders: { zh: "我的订单", en: "My Orders" },
  dualOrdersActive: { zh: "现有订单", en: "Active Orders" },
  dualOrdersHistory: { zh: "历史订单", en: "Order History" },
  
  // Dual Investment - Filters
  dualFilterAll: { zh: "全部", en: "All" },
  
  // Dual Investment - Stats
  dualTotalInvest: { zh: "总投入", en: "Total Investment" },
  dualTotalProfit: { zh: "总盈利", en: "Total Profit" },
  dualAvgAPR: { zh: "平均 APR", en: "Avg APR" },
  dualExpectedProfit: { zh: "预期收益", en: "Expected profit" },
  dualActualProfit: { zh: "实际收益", en: "Actual" },
  dualProfit: { zh: "收益", en: "Profit" },
  dualNoOrders: { zh: "暂无订单", en: "No orders" },
  dualInvestNotionalUnavailableHint: {
    zh: "订单接口未返回可展示的本金（数量+币种），常见于「高卖」与接口字段不一致。真实金额请在欧易 App 查看；字段说明见仓库 docs/okx-dcd-api-reference.md。",
    en: "Order API returned no displayable notional (amount + currency); common for sell-high vs field names. Check amounts in the OKX app; see docs/okx-dcd-api-reference.md.",
  },

  // Dual Investment - Config
  ...
  dualAvailableProducts: { zh: "可购买产品", en: "Available Products" },
  allSettleDates: { zh: "全部日期", en: "All Dates" },
  noProductsForDate: { zh: "该日期暂无产品", en: "No products for selected date" },
  ...
  llmModelPlaceholder: { zh: "模型名称，如 google/gemini-2.5-flash", en: "Model name, e.g. google/gemini-2.5-flash" },
  ...
  llmSaveToTest: { zh: "请先保存配置后再测试", en: "Save config before testing" },
  ...
  accountsSubtitle: {
    zh: "多账户资产汇总，持仓与参考行情以服务器计算为准。",
    en: "Multi-account overview; positions and reference quotes are computed on the server.",
  },
  ...
  manageHoldings: { zh: "管理持仓", en: "Manage holdings" },
  pieByAccount: { zh: "按账户", en: "By account" },
  pieByAssetClass: { zh: "按大类", en: "By asset class" },
  accountAllocationTitle: { zh: "账户资产占比", en: "Account allocation" },
  assetClassAllocationTitle: {
    zh: "大类资产占比（按市场类型汇总）",
    en: "Asset class allocation (by platform)",
  },
  chartMixedCcyNote: {
    zh: "未统一汇率，占比仅供直观参考。",
    en: "Mixed currencies not FX-converted; shares are indicative only.",
  },
  chartCnyAggregatedNote: {
    zh: "下列汇总与饼图已按配置汇率统一折算为人民币，仅供参考。",
    en: "Totals and pie below are converted to CNY using configured FX rates (indicative).",
  },
  /** @deprecated prefer refreshAccounts */
  refreshPrices: { zh: "刷新行情", en: "Refresh quotes" },
  refreshAccounts: { zh: "刷新账户", en: "Refresh accounts" },
  refreshAccountsTooltip: {
    zh: "非实时行情。点击以重新拉取各账户持仓参考价并更新汇总。",
    en: "Delayed quotes. Click to reload reference prices for all holdings and refresh totals.",
  },
  accountHoldingsTitle: { zh: "账户持仓", en: "Account positions" },
  accountNotFound: { zh: "未找到该账户", en: "Account not found" },
  holdingTicker: { zh: "代码", en: "Ticker" },
  optionPut: { zh: "看跌", en: "Put" },
  optionCall: { zh: "看涨", en: "Call" },
  strikePrice: { zh: "行权价", en: "Strike" },
  ...
  deleteHoldingConfirm: { zh: "确定删除该持仓？", en: "Delete this holding?" },
  holdingSaved: { zh: "持仓已保存", en: "Holding saved" },
  holdingFormInvalid: { zh: "请填写代码、数量与成本", en: "Enter ticker, quantity, and average cost" },
  assetType: { zh: "资产类型", en: "Asset Type" },
  assetStock: { zh: "股票", en: "Stock" },
  assetEtf: { zh: "ETF", en: "ETF" },
  ...
  // Error messages
  llmError: { zh: "AI 调用失败", en: "AI call failed" },
  llmErrorUnknown: { zh: "未知错误", en: "Unknown error" },
...
export function I18nProvider({ children }: { children: ReactNode }) {
  ...
  // Rule: rerender-dependencies - Memoize context value to prevent unnecessary re-renders
  const value = useMemo(() => ({
    lang,
    setLang: changeLang,
    t,
